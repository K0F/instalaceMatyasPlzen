...
(sleep 15s && (cd /home/kof && ./updateGame.sh && (sleep 60s && xdotool key --repeat 5 --repeat-delay 100 Tab key Return)) || (cd /home/kof/Downloads/catGame_linuBuild_ver1_0 && ./catGame-3-linux.x86_64 -popupwindow -screen-width 1600 -screen-height 1280) && (sleep 20s && xdotool key --repeat 5 --repeat-delay 100 Tab key Return)) &
